...
class LeaveRequestController extends Controller
{
    ...
    {
        return DataTables::of(LeaveRequestModel::with('employee'))
    ...
    public function store(Request $request)
    {
        $validateData = $request->validate([
            ...
            'status_request' => 'required|in:accepted,rejected,pending',
        ]);

        // take role from user account
        $user = Auth::user();
        $role = $user->role;
